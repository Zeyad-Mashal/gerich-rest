  ...
  <div className='app__specialMenu flex__center section__padding' id='menu'>
    ...
    <div className='app__specialMenu-content'>
      <div className='app__specialMenu-content_drinks flex__center'>
        <p className='app__specialMenu-content_menu_heading'>Drinks & Coffee</p>
        <div className='app__specialMenu-content_menu_items'>
      ...
      <div className='app__specialMenu-content_cocktails flex__center'>
        <p className='app__specialMenu-content_menu_heading'>Cocktails</p>
        <div className='app__specialMenu-content_menu_items'>
